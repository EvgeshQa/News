package com.evgesha.controllers;
...
public class BlogController {
    ...
    public String blogPostUpdate(@AuthenticationPrincipal User user, @PathVariable(value = "id") long id, @RequestParam String title, @RequestParam String anons, @RequestParam String full_text, Model model){
